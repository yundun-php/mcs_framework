...
namespace YundunMcs\Serializer;

use Throwable;
use YundunMcs\Serializer\Contracts\Serializer;
...
class PhpSerializer implements Serializer
{
     ...
     *
     * @throws YundunMcs\Serializer\Exception\SerializerException Thrown when serialization fails.
     *
     * @return string
     */
     ...
     *
     * @throws YundunMcs\Serializer\Exception\SerializerException Thrown when deserialization fails.
     *
     * @return mixed
     */
