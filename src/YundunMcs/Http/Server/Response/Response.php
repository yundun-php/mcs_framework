...
class Response implements Arrayable
{
     ...
     *
     * @var YundunMcs\Http\Foundation\Collection
     */
    protected $content;
     ...
     *
     * @return YundunMcs\Http\Foundation\Collection
     */
