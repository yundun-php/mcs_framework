...
use YundunMcs\Http\Server\Traits\RequestExtrasSupport;
use YundunMcs\Http\Server\Traits\RequestHeadersSupport;
use YundunMcs\Http\Server\Traits\RequestAttributesSupport;
use YundunMcs\Http\Server\Traits\RequestPostContentSupport;
...
class Request implements Arrayable
{
     ...
     *
     * @var YundunMcs\Http\Server\Globals\Server
     */
    protected $server;
     ...
     *
     * @var YundunMcs\Http\Server\Globals\Body
     */
    protected $body;
     ...
     *
     * @var YundunMcs\Http\Server\Globals\Query
     */
    protected $query;
     ...
     *
     * @var YundunMcs\Http\Server\Globals\Cookies
     */
    protected $cookies;
     ...
     *
     * @return YundunMcs\Http\Server\Globals\Server
     */
     ...
     *
     * @return YundunMcs\Http\Server\Globals\Body
     */
     ...
     *
     * @return YundunMcs\Http\Server\Globals\Query
     */
     ...
     *
     * @return YundunMcs\Http\Server\Globals\Cookies
     */
