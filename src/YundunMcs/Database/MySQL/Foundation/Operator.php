...
namespace YundunMcs\Database\MySQL\Foundation;
...
class Operator
{
     ...
     *
     * @throws YundunMcs\Database\MySQL\Exceptions\GrammarException Throws when the filter simple operator is invalid.
     *
     * @return string
     */
     ...
     *
     * @throws YundunMcs\Database\MySQL\Exceptions\GrammarException Throws when the filter range operator is invalid.
     *
     * @return string
     */
     ...
     *
     * @throws YundunMcs\Database\MySQL\Exceptions\GrammarException Throws when the filter null operator is invalid.
     *
     * @return string
     */
