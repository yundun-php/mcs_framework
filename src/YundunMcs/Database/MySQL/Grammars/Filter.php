...
use YundunMcs\Database\MySQL\Foundation\Operator;
...
class Filter implements Arrayable, Countable
{
     ...
     * @param string|null $connector The filter connector.
     *
     * @throws YundunMcs\Database\MySQL\Exceptions\GrammarException Thrown when the column value is empty.
     *
     * @return self
     */
     ...
     * @param string|null $connector The filter connector.
     *
     * @throws YundunMcs\Database\MySQL\Exceptions\GrammarException Thrown when the column value is invalid.
     *
     * @return self
     */
     ...
     * @param YundunMcs\Container\Wrapper $wrapper   The filter wrapper instance.
     * @param string|null              $connector The filter connector.
     *
     * @return self
     */
