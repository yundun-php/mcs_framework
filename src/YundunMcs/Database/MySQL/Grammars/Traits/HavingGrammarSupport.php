...
trait HavingGrammarSupport
{
     ...
     *
     * @throws YundunMcs\Database\MySQL\Exceptions\GrammarException Thrown when a parameter is missing.
     * @throws YundunMcs\Database\MySQL\Exceptions\GrammarException Thrown when the filter column is invalid.
     *
     * @return self
     */
