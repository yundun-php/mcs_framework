...
class InsertGrammar extends AbstractGrammar
{
     ...
     *
     * @throws YundunMcs\Database\MySQL\Exceptions\GrammarException Thrown when the column data is empty.
     * @throws YundunMcs\Database\MySQL\Exceptions\GrammarException Thrown when the column does not exist or is not writable.
     *
