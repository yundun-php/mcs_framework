...
use YundunMcs\Database\MySQL\Exceptions\ArgumentException;
...
class Arguments implements Arrayable, Countable, IteratorAggregate, JsonSerializable
{
     ...
     * @param mixed $parameters The statement binding parameters.
     *
     * @throws YundunMcs\Database\MySQL\Exceptions\ArgumentException Thrown when the statement binding parameter is invalid.
     *
     * @return self
     */
