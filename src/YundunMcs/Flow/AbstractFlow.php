...
use YundunMcs\Flow\Contracts\Flow;
...
abstract class AbstractFlow implements Flow
{
     ...
     * The flow blocker.
     *
     * @var YundunMcs\Flow\Contracts\Blocker
     */
    protected $blocker;
     ...
     *
     * @param YundunMcs\Flow\Contracts\Blocker $blocker The flow blocker.
     *
     * @return void
     */
     ...
     *
     * @return YundunMcs\Flow\Contracts\Blocker
     */
     ...
     *
     * @return YundunMcs\Flow\ProcessorQueue
     */
     ...
     * Run flow processors.
     *
     * @param YundunMcs\Flow\ProcessorQueue $queue The processor queue.
