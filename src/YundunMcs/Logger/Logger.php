...
class Logger
{
     ...
     *
     * @param YundunMcs\Logger\AbstractHandler|callable $handler The log handler.
    ...
    public function pushHandler($handler, bool $top = true): int
    {
        ...
        // For a callable structure, we wrap it as a "YundunMcs\Logger\Handlers\CallableHandler"
     ...
     *
     * @return YundunMcs\Logger\AbstractHandler
     */
