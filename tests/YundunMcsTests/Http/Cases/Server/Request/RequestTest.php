...
use YundunMcs\Http\Server\Request\Request;
...
class RequestTest extends TestCase
{
    ...
    {
        $this->assertEquals('YundunMcs/1.x', $this->createRequest()->getUserAgent());

        $this->server['HTTP_USER_AGENT'] = 'YundunMcs/1.0.x';
        $this->assertEquals('YundunMcs/1.0.x', $this->createRequest()->getUserAgent());
