...
// The YundunMcs framework library root directory.
define('EDOGER_ROOT', realpath(__DIR__.'/../'));

// The YundunMcs framework library tests root directory.
define('EDOGER_TESTS_ROOT', EDOGER_ROOT.'/tests');

// The YundunMcs framework library tests temp directory.
